...
echo "  qwen extensions install \"$ZIP_PATH\""
echo "  agent-aura-qwencode configure --transport http --host 127.0.0.1 --port 47831 --auto-discover false"
echo "  agent-aura-qwencode install-hooks"
echo "  # Then fully restart Qwen Code"
